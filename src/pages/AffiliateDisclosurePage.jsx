...
function AffiliateDisclosurePage() {
  return (
    ...
    >
      <p>
        Focama is currently focused on publishing original buying-guidance content. At this stage,
        the site may discuss products, categories, or buying considerations without yet using live
        affiliate links across the experience.
      </p>
      <p>
        In the future, Focama may participate in affiliate programs, including Amazon Associates.
        If and when affiliate links are added, the site will provide clear disclosures so users
