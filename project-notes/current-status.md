...
- Result rows/cards and modal facts now combine rating plus review count into one quality signal, leaving room for at most one delivery signal and avoiding marketplace-style metadata clutter.
