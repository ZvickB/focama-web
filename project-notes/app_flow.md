...
- The v1 hidden-image set includes women’s intimate apparel, swimwear, shapewear/bodysuits, crop tops, lingerie, sensitive grooming listings, and sensitive-topic book covers. Ordinary shorts, tank tops, leggings, men’s boxers, and boxer briefs remain visible. Safe accessories such as organizers, wash bags, extenders, and hangers are allowlisted. If moderation leaves fewer credible candidates, the app returns fewer picks instead of making an extra provider request.
