...
- Cosmetic variants of the same identified product model are removed deterministically before Haiku and again after its ordered shortlist. Unique Haiku picks preserve their order; replacements from the server-owned candidate pool append at the end. This is not a brand/company cap: distinct models, generations, capacities, widths, and major feature tiers remain eligible.
