...
- Account-level ranking priority preference (balanced/price/brands/variety) is specced but not built: see `project-notes/plans/account-priority-preference-plan.md`. Awaiting design review (Codex opinion) before implementation; depends on auth QA above.
