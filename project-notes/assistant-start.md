...
- Cosmetic variants of the same identified product model are removed before Haiku and after its ordered shortlist; unique Haiku picks retain their order and deterministic replacements append at the end. This does not limit brands/companies, while different models, generations, capacities, widths, and major feature tiers stay distinct.
