...
- Cosmetic variants of an identified product model are removed deterministically before Haiku and after its ordered six. Unique Haiku picks retain their order; deterministic replacements from the 30-candidate pool append at the end. This does not cap brands/companies, and keeps different models, generations, capacities, widths, and major feature tiers distinct.
